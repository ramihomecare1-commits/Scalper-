...
<b>Size:</b> {trade_data.get('size', 'N/A')}
<b>Risk/Reward:</b> {trade_data.get('risk_reward', 'N/A')}:1
<b>Confidence:</b> {trade_data.get('confidence', 'N/A')}%

<i>Reasoning:</i> {trade_data.get('reasoning', 'AI-based decision')}
"""
...
<b>Total Trades:</b> {trade_data.get('total_trades', 'N/A')}
<b>Win Rate:</b> {trade_data.get('win_rate', 'N/A')}%
"""
